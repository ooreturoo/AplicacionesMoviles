...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        NavigationUI.setupActionBarWithNavController(this,navFragment.navController)

        NavigationUI.setupWithNavController(binding.bnvMenu, navFragment.navController)
